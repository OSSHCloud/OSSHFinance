...
import { LID_DELETE_ID, TRY_AGAIN_LATER } from 'src/utils/constants';
...
export class TransactionService {
  constructor(
    ...
    private readonly mainRepository: Repository<Transaction>,
    @InjectRepository(TransactionHistory)
    private readonly historyRepositry: Repository<TransactionHistory>,
  ) {}
